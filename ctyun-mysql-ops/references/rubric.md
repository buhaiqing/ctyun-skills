...
| 5 | Spec Compliance | 0/0.5/1 | ≥0.5 | Follows SQL syntax and MySQL best practices |
...
| 1 | Full trace: CLI command, MySQL response, rows affected, errors |
...
| 0.5 | Correct but suboptimal (e.g., SELECT * without WHERE) |
| 1 | Follows SQL best practices, proper quoting, safe patterns |
